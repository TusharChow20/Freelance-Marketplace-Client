...
const Jobs = ({ job }) => {
  ...
  return (
    <div className="card bg-base-100 w-full h-[450px] shadow-xl hover:shadow-2xl transition-all duration-300 border border-base-300 overflow-hidden group relative z-0">
      ...
      <div className="card-body absolute inset-0 justify-between text-white z-10">
        <div>
          ...
          {/* --------------------------Summary ------------------------*/}
          <p className="text-white flex-grow line-clamp-4 leading-relaxed drop-shadow">
            {job.summary}
          </p>
        </div>
